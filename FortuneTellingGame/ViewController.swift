...
//    func settingTextView(PickerN : Int, BloodN : Int, SliderN : Int) -> String {
//        return pickerShow[PickerN] + bloodType[BloodN] + sliderMessage[SliderN]
//    }
//
...
//        resultView.text = settingTextView(PickerN: setPickerNumber(), BloodN: setBloodNumber(), SliderN: setSliderNumber())
